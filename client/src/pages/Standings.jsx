...
//     }
//     const data = await getLeagueStandings(leagueCode, season);
//     standingsCache.set(key, { data, timestamp: Date.now() });
//     return data;
//   };
...
//                   <span className="text-2xl">{league.flag}</span>
//                   <div className="text-left">
//                     <div className="text-lg">{league.shortName}</div>
//                     <div className="text-sm opacity-90">{league.country}</div>
//                   </div>
//                 </div>
//                 {selectedLeague === league.code && (
//                   <div className="absolute -top-1 -right-1 w-6 h-6 bg-white rounded-full flex items-center justify-center">
...
//           {!loading && !error && standingsData?.standings && (
//             <StandingsTable
//               standings={standingsData.standings}
//               competition={standingsData.competition}
//               season={standingsData.season}
